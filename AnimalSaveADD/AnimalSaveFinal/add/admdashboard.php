    ...
    <tbody>
      <?php foreach ($clientes as $cliente): ?>
        <tr>
          ...
          <td>
            <button class="btn btn-sm btn-primary editar-cliente" 
...
<div class="modal fade" id="modalEditarCliente" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="formEditarCliente" method="POST" action="../actions/editar_cliente.php">
        <div class="modal-body">
          <input type="hidden" name="id_cliente" id="editar-id-cliente">
          <input type="hidden" name="cpf" id="editar-cpf"> <!-- Mudei para hidden -->
          <div class="mb-3">
            <label class="form-label">CPF</label>
            <input type="text" class="form-control" id="visualizar-cpf" readonly> <!-- Campo somente leitura -->
          </div>
          <div class="mb-3">
            <label for="editar-nome-cliente" class="form-label">Nome</label>
            <input type="text" class="form-control" id="editar-nome-cliente" name="nome" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="editar-endereco" name="endereco" rows="2"></textarea>
          </div>
        </div>
...
$(document).on('click', '.editar-cliente', function() {
  ...
  $('#editar-id-cliente').val(id);
  $('#editar-cpf').val(cpf); // Campo hidden que será enviado
  $('#visualizar-cpf').val(cpf); // Campo visualização somente leitura
  $('#editar-nome-cliente').val(nome);
  $('#editar-email').val(email);
  $('#editar-telefone').val(telefone);
  $('#editar-endereco').val(endereco);
